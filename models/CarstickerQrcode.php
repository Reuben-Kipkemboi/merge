...
use app\modules\setup\models\CsCarstickerValidity;
 ...
 */
class CarstickerQrcode extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['validity_id'], 'exist', 'skipOnError' => true, 'targetClass' => CsCarstickerValidity::class, 'targetAttribute' => ['validity_id' => 'validity_id']],
        ];
    }
    ...
    public function getCarstickerApplication()
    {
